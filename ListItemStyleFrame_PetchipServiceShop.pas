...
type
  TFramePetchipServiceShopListItemStyle = class(TFrameBaseListItemStyleBase)
...
var
  FramePetchipServiceShopListItemStyle: TFramePetchipServiceShopListItemStyle;
...
finalization
  UnRegisterListItemStyle('PetchipServiceShop');
